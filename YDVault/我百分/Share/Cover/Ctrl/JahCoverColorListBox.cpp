...
/*  ColorListBox.cpp												*/
/*																	*/
/*  Implementation of the CJahCoverColorListBox.							*/
/*																	*/
...
CJahCoverColorListBox::CJahCoverColorListBox()
{
}
...
BEGIN_MESSAGE_MAP(CJahCoverColorListBox, CListBox)
	//{{AFX_MSG_MAP(CJahCoverColorListBox)
...
int CJahCoverColorListBox::AddString(LPCTSTR lpszItem, COLORREF itemColor)
{
...
void CJahCoverColorListBox::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
    // Losing focus ?
	...
	{
		CBrush brush(GetBkColor(lpDrawItemStruct->hDC));
		pDC->FillRect(&lpDrawItemStruct->rcItem, &brush);
	}	 	
...
/* Description   : Inform Windows of the list-box dimensions.		*/
/*																	*/
/********************************************************************/
//##ModelId=4140A36800F0
void CJahCoverColorListBox::MeasureItem(LPMEASUREITEMSTRUCT lpMeasureItemStruct) 
{
