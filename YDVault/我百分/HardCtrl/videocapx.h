#if !defined(AFX_VIDEOCAPX_H__9F57121F_C038_4606_B2EA_E918DCEBEB23__INCLUDED_)
#define AFX_VIDEOCAPX_H__9F57121F_C038_4606_B2EA_E918DCEBEB23__INCLUDED_
...
public:
	...
	BOOL GetUseClosedCaption();
	void SetUseClosedCaption(BOOL);
	long GetServerTimeout();
	void SetServerTimeout(long);
	float GetResizeBroadcast();
	void SetResizeBroadcast(float);
	double GetScaleVideo();
	void SetScaleVideo(double);
...
public:
	...
	CPicture ReceiveFrame(LPCTSTR ServerName);
	...
	long SetChromaKey(LPCTSTR BackImage, long MinTransparentColor, long MaxTransparentColor, long BackOrFront);
	long PlayRemoteAudio(LPCTSTR RemoteAddress);
	long SetSourceVideoSubType(LPCTSTR SubType);
	VARIANT GetRawSample(long width);
	VARIANT GetVideoSubtypes();
	LPUNKNOWN DvdControl();
	long SetAlphaBitmap(long hDC, float x, float y, float W, float H, float Alpha, long SrcKey);
	long SetTunerMode(long Mode);
	long GetVideoProcAmp(long ValueIndex);
	void SetVideoProcAmp(long ValueIndex, long nNewValue);
	long PlayerOpenBroadcastPush(LPCTSTR filename, LPCTSTR URL, LPCTSTR username, LPCTSTR password);
	...
	long SetOption(long OptionIndex, const VARIANT& Value);
	long ConnectionState();
	long Ping(LPCTSTR ServerAddress, long Timeout);
};

//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_VIDEOCAPX_H__9F57121F_C038_4606_B2EA_E918DCEBEB23__INCLUDED_)
