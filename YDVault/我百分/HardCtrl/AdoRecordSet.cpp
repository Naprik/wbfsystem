...
extern void RqShowDebug(LPCTSTR lpszFormat, ...);
...
BOOL CAdoRecordSet::Open(LPCTSTR strSQL, long lOption, CursorTypeEnum CursorType, LockTypeEnum LockType)
{
	...
	{
		RqShowDebug(_T("Warning: 打开记录集发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		RqShowDebug(_T("%s\r\n"), GetLastError());
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::Requery(long Options)
{
	...
	{
		RqShowDebug(_T("Warning: Requery 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::Resync(AffectEnum AffectRecords, ResyncEnum ResyncValues)
{
	...
	{
		RqShowDebug(_T("Warning: Resync 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::Save(LPCTSTR strFileName, PersistFormatEnum PersistFormat)
{
	...
	{
		RqShowDebug(_T("Warning: Save 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::Load(LPCTSTR strFileName)
{
	...
	{
		RqShowDebug(_T("Warning: Load 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::Cancel()
{
	...
	{
		RqShowDebug(_T("Warning: Cancel发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
void CAdoRecordSet::Close()
{
	...
	{
		RqShowDebug(_T("Warning: 关闭记录集发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
	}
}
...
BOOL CAdoRecordSet::AddNew()
{
	...
	{
		RqShowDebug(_T("Warning: AddNew 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::Update()
{
	...
	{
		RqShowDebug(_T("Warning: Update 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
	}
...
BOOL CAdoRecordSet::UpdateBatch(AffectEnum AffectRecords)
{
	...
	{
		RqShowDebug(_T("Warning: UpdateBatch 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::CancelUpdate()
{
	...
	{
		RqShowDebug(_T("Warning: CancelUpdate 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::CancelBatch(AffectEnum AffectRecords)
{
	...
	{
		RqShowDebug(_T("Warning: CancelBatch 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::Delete(AffectEnum AffectRecords)
{
	...
	{
		RqShowDebug(_T("Warning: Delete发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MoveFirst()
{
	...
	{
		RqShowDebug(_T("Warning: MoveFirst 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MoveLast()
{
	...
	{
		RqShowDebug(_T("Warning: MoveLast 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MovePrevious()
{
	...
	{
		RqShowDebug(_T("Warning: MovePrevious 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
	return FALSE;	
}
...
BOOL CAdoRecordSet::MoveNext()
{
	...
	{
		RqShowDebug(_T("Warning: MoveNext 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::Move(long lRecords, _variant_t Start)
{
	...
	{
		RqShowDebug(_T("Warning: Move 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
long CAdoRecordSet::GetState()
{
	...
	{
		RqShowDebug(_T("Warning: GetState 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	} 
	return -1;
}
...
BOOL CAdoRecordSet::IsOpen()
{
	...
	{
		RqShowDebug(_T("Warning: IsOpen方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
long CAdoRecordSet::GetStatus()
{
	...
	{
		RqShowDebug(_T("Warning: GetStatus 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	} 
	return -1;
}
...
long CAdoRecordSet::GetRecordCount()
{
	...
	{
	//	RqShowDebug(_T("Warning: GetRecordCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	} 
}
...
long CAdoRecordSet::GetFieldsCount()
{
	...
	{
		RqShowDebug(_T("Warning: GetFieldsCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	} 
}
/*========================================================================
...
long CAdoRecordSet::GetMaxRecordCount()
{
	...
	{
		RqShowDebug(_T("Warning: GetMaxRecordCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::IsBOF()
{
	...
	{
		RqShowDebug(_T("Warning: IsBOF 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::IsEOF()
{
	...
	{
		RqShowDebug(_T("Warning: IsEOF 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
long CAdoRecordSet::GetPageCount()
{
	...
	{
		RqShowDebug(_T("Warning: GetPageCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetCacheSize(const long &lCacheSize)
{
	...
	{
		RqShowDebug(_T("Warning: SetCacheSize方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
	return TRUE;
}
...
BOOL CAdoRecordSet::SetAbsolutePage(int nPage)
{
	...
	{
		RqShowDebug(_T("Warning: SetAbsolutePage 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
long CAdoRecordSet::GetAbsolutePage()
{
	...
	{
		RqShowDebug(_T("Warning: GetAbsolutePage 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetAbsolutePosition(int nPosition)
{
	...
	{
		RqShowDebug(_T("Warning: SetAbsolutePosition 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
long CAdoRecordSet::GetAbsolutePosition()
{
	...
	{
		RqShowDebug(_T("Warning: GetAbsolutePosition 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetCursorLocation(CursorLocationEnum CursorLocation)
{
	...
	{
		RqShowDebug(_T("Warning: PutCursorLocation 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
CursorLocationEnum CAdoRecordSet::GetCursorLocation()
{
	...
	{
		RqShowDebug(_T("Warning: GetCursorLocation 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return adUseNone;
	}
}
...
BOOL CAdoRecordSet::SetCursorType(CursorTypeEnum CursorType)
{
	...
	{
		RqShowDebug(_T("Warning: SetCursorType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
CursorTypeEnum CAdoRecordSet::GetCursorType()
{
	...
	{
		RqShowDebug(_T("Warning: GetCursorType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
...
FieldsPtr CAdoRecordSet::GetFields()
{
	...
	{
		RqShowDebug(_T("Warning: GetFields 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return NULL;
	} 
	return NULL;
}
...
CString CAdoRecordSet::GetFieldName(long lIndex)
{
	...
	{
		RqShowDebug(_T("Warning: GetFieldName 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
	}
	return strFieldName;
}
...
long CAdoRecordSet::GetFieldAttributes(long lIndex)
{
	...
	{
		RqShowDebug(_T("Warning: GetFieldAttributes 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	}
}
...
long CAdoRecordSet::GetFieldDefineSize(long lIndex)
{
	...
	{
		RqShowDebug(_T("Warning: GetDefineSize 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	}
}
...
long CAdoRecordSet::GetFieldActualSize(long lIndex)
{
	...
	{
		RqShowDebug(_T("Warning: GetFieldActualSize 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	}	
}
...
DataTypeEnum CAdoRecordSet::GetFieldType(long lIndex)
{
	...
	{
		RqShowDebug(_T("Warning: GetField 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return adEmpty;
	}	
}
...
DataTypeEnum CAdoRecordSet::GetFieldType(LPCTSTR lpszFieldName)
{
	...
	{
		RqShowDebug(_T("Warning: GetField发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return adEmpty;
	}	
}
...
BOOL CAdoRecordSet::IsFieldNull(LPCTSTR lpFieldName)
{
	...
	{
		RqShowDebug(_T("Warning: IsFieldNull 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::PutCollect(long index, const _variant_t &value)
{
	...
	{
		RqShowDebug(_T("Warning: PutCollect 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::GetCollect(long index, COleDateTime &value)
{
	...
	try
	{
		value = CAdoConnection::vartodate(m_pRecordset->GetCollect(_variant_t(index)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(LPCTSTR strFieldName, COleDateTime &value)
{
	...
	try
	{
		value = CAdoConnection::vartodate(m_pRecordset->GetCollect(_variant_t(strFieldName)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(long index, COleCurrency &value)
{
	...
	try
	{
		value = CAdoConnection::vartocy(m_pRecordset->GetCollect(_variant_t(index)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(LPCTSTR strFieldName, COleCurrency &value)
{
	...
	try
	{
		value = CAdoConnection::vartocy(m_pRecordset->GetCollect(_variant_t(strFieldName)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(long index,  bool &value)
{
	...
	try
	{
		value = CAdoConnection::vartobool(m_pRecordset->GetCollect(_variant_t(index)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(LPCSTR strFieldName,  bool &value)
{
	...
	try
	{
		value = CAdoConnection::vartobool(m_pRecordset->GetCollect(_variant_t(strFieldName)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(long index,  BYTE &value)
{
	...
	try
	{
		value = CAdoConnection::vartoby(m_pRecordset->GetCollect(_variant_t(index)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(LPCSTR strFieldName,  BYTE &value)
{
	...
	try
	{
		value = CAdoConnection::vartoby(m_pRecordset->GetCollect(_variant_t(strFieldName)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(long index,  short &value)
{
	...
	try
	{
		value = CAdoConnection::vartoi(m_pRecordset->GetCollect(_variant_t(index)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(LPCSTR strFieldName,  short &value)
{
	...
	try
	{
		value = CAdoConnection::vartoi(m_pRecordset->GetCollect(_variant_t(strFieldName)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(long index,  int &value)
{
	...
	try
	{
		value = (int)CAdoConnection::vartol(m_pRecordset->GetCollect(_variant_t(index)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(LPCSTR strFieldName,  int &value)
{
	...
	try
	{
		value = (int)CAdoConnection::vartol(m_pRecordset->GetCollect(_variant_t(strFieldName)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(long index,  long &value)
{
	...
	try
	{
		value = CAdoConnection::vartol(m_pRecordset->GetCollect(_variant_t(index)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(LPCSTR strFieldName,  long &value)
{
	...
	try
	{
		value = CAdoConnection::vartol(m_pRecordset->GetCollect(_variant_t(strFieldName)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(long index,  DWORD &value)
{
	...
	try
	{
		...
		case VT_EMPTY:
			...
			break;
		default:
			//RqShowDebug(_T("Warning: 无法读取相应的字段, 数据类型不匹配; 文件: %s; 行: %d\n"), __FILE__, __LINE__);
			return FALSE;
		}		
		return TRUE;
	}
...
BOOL CAdoRecordSet::GetCollect(long index,  double &value)
{
	...
	try
	{
		value = CAdoConnection::vartof(m_pRecordset->GetCollect(_variant_t(index)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(LPCSTR strFieldName,  double &value)
{
	...
	try
	{
		value = CAdoConnection::vartof(m_pRecordset->GetCollect(_variant_t(strFieldName)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(long index, CString& strValue)
{
	...
	try
	{
		...
		strValue = CAdoConnection::vartostr(value);
		return TRUE;
	}
	catch (_com_error e)
	{
		RqShowDebug(_T("Warning: 字段访问失败. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
...
BOOL CAdoRecordSet::AppendChunk(FieldPtr pField, LPVOID lpData, UINT nBytes)
{
	...
	{
		RqShowDebug(_T("Warning: AppendChunk 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::GetChunk(FieldPtr pField, LPVOID lpData)
{
	...
	{ 
		...
		{
			RqShowDebug(_T("Warning: GetChunk 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
			return FALSE;
		}
	}
...
BOOL CAdoRecordSet::Supports(CursorOptionEnum CursorOptions)
{
	...
	{
		RqShowDebug(_T("Warning: Supports方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::SetFilter(LPCTSTR lpszFilter)
{
	...
	{
		RqShowDebug(_T("Warning: SetFilter 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
_variant_t CAdoRecordSet::GetBookmark()
{
	...
	{
		RqShowDebug(_T("Warning: GetBookmark 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
	}
...
BOOL CAdoRecordSet::SetBookmark(_variant_t varBookMark)
{
	...
	{
		RqShowDebug(_T("Warning: SetBookmark 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::Clone(CAdoRecordSet &pRecordSet)
{
	...
	{
		RqShowDebug(_T("Warning: Clone 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
/*========================================================================
...
BOOL CAdoRecordSet::Find(LPCTSTR lpszFind, SearchDirectionEnum SearchDirection)
{
	...
	{
		RqShowDebug(_T("Warning: Find 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::FindNext()
{
	...
	{
		RqShowDebug(_T("Warning: FindNext 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::RecordBinding(CADORecordBinding &pAdoRecordBinding)
{
	...
	{
		RqShowDebug(_T("Warning: RecordBinding 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
