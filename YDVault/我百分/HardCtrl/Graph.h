...
#define PIE_GRAPH				2
#define BAR_GRAPH_3D			3
#define LINE_GRAPH_3D			4	//looks like a "tape" graph
#define PIE_GRAPH_3D			5
#define STACKED_BAR_GRAPH		6
#define XY_LINE_GRAPH			7	//straight line, no circles at data points
#define STACKED_BAR_GRAPH_3D	8
#define BOX_WHISKER_GRAPH		9
#define SCATTER_GRAPH			10
