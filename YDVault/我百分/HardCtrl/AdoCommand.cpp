...
void RqShowDebug(LPCTSTR lpszFormat, ...)
{
#ifdef _DEBUG
	CString str;
    va_list args;
...
void CAdoCommand::Release()
{
	...
	{
		RqShowDebug(_T("Warning: Release方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
	} 
}
								  ...
								  _variant_t Value)
{
	...
	{
		RqShowDebug(_T("Warning: CreateParameter 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return NULL;
	} 
}
...
BOOL CAdoCommand::SetCommandText(LPCTSTR lpstrCommand)
{
	...
	{
		RqShowDebug(_T("Warning: PutCommandText 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
}
...
BOOL CAdoCommand::SetConnection(CAdoConnection *pConnect)
{
	...
	{
		RqShowDebug(_T("Warning: SetConnection 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
}
/*========================================================================
...
BOOL CAdoCommand::SetCommandType(CommandTypeEnum CommandType)
{
	...
	{
		RqShowDebug(_T("Warning: PutCommandType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
}
...
BOOL CAdoCommand::SetCommandTimeOut(long lTime)
{
	...
	{
		RqShowDebug(_T("Warning: SetCommandTimeOut 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
}
...
BOOL CAdoCommand::Append(_ParameterPtr param)
{
	...
	{
		RqShowDebug(_T("Warning: Append 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
}
...
_ParameterPtr CAdoCommand::GetParamter(LPCTSTR lpstrName)
{
	...
	{
		RqShowDebug(_T("Warning: GetParamter 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return NULL;
	} 
}
...
_variant_t CAdoCommand::GetValue(long index)
{
	...
	{
		RqShowDebug(_T("Warning: GetValue 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		_variant_t vt;
		vt.vt = VT_NULL;
		return vt;
	} 
...
CAdoParameter CAdoCommand::operator [](int index)
{
	...
	{
		RqShowDebug(_T("Warning: operator [] 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
	}
	return pParameter;
}
...
BOOL CAdoParameter::SetPrecision(char nPrecision)
{
	...
	{
		RqShowDebug(_T("Warning: SetPrecision 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoParameter::SetType(DataTypeEnum DataType)
{
	...
	{
		RqShowDebug(_T("Warning: SetType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}	
}
...
DataTypeEnum CAdoParameter::GetType()
{
	...
	{
		RqShowDebug(_T("Warning: SetDirection 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return adEmpty;
	}
}
...
BOOL CAdoParameter::SetSize(int size)
{
	...
	{
		RqShowDebug(_T("Warning: SetSize 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}	
}
...
BOOL CAdoParameter::SetName(CString strName)
{
	...
	{
		RqShowDebug(_T("Warning: SetName 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}	
}
...
BOOL CAdoParameter::SetValue(const bool &value)
{
	...
	{
		RqShowDebug(_T("Warning: SetValue 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoParameter::GetValue(bool &value)
{
	try
	{
		value = CAdoConnection::vartobool(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(BYTE &value)
{
	try
	{
		value = CAdoConnection::vartoby(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(short &value)
{
	try
	{
		value = CAdoConnection::vartoi(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(int &value)
{
	try
	{
		value = (int)CAdoConnection::vartol(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(long &value)
{
	try
	{
		value = CAdoConnection::vartol(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(double &value)
{
	try
	{
		value = CAdoConnection::vartof(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(CString &value)
{
	try
	{
		value = CAdoConnection::vartostr(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(COleDateTime &value)
{
	try
	{
		value = CAdoConnection::vartodate(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
