...
/*########################################################################
							    数值类型转换
########################################################################*/
COleDateTime CAdoConnection::vartodate(const _variant_t& var)
{
	COleDateTime value;
	switch (var.vt) 
	{
	...
	case VT_NULL:
		...
		break;
	default:
//		RqShowDebug(_T("Warning: 未处理的 _variant_t 类型值; 文件: %s; 行: %d\n"), __FILE__, __LINE__);
		value.SetStatus(COleDateTime::null);
	}
	return value;
}

COleCurrency CAdoConnection::vartocy(const _variant_t& var)
{
	COleCurrency value;
	switch (var.vt) 
	{
...
bool CAdoConnection::vartobool(const _variant_t& var)
{
	bool value = false;
	switch (var.vt)
	{
...
BYTE CAdoConnection::vartoby(const _variant_t& var)
{
	BYTE value = 0;
	switch (var.vt)
	{
...
short CAdoConnection::vartoi(const _variant_t& var)
{
	short value = 0;
	switch (var.vt)
	{
...
long CAdoConnection::vartol(const _variant_t& var)
{
	long value = 0;
	switch (var.vt)
	{
...
double CAdoConnection::vartof(const _variant_t& var)
{
	double value = 0;
	switch (var.vt)
	{
...
CString CAdoConnection::vartostr(const _variant_t &var)
{
	CString strValue;
...
BOOL CAdoConnection::Open(LPCTSTR lpszConnect, long lOptions)
{
	...
	{
		RqShowDebug(_T("Warning: 连接数据库发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		RqShowDebug(_T("%s\r\n"), GetLastErrorText());
		return FALSE;
	} 
	catch (...)
	{
		RqShowDebug(_T("Warning: 连接数据库时发生未知错误:"));
	}
	return FALSE;
}
...
void CAdoConnection::Close()
{
	...
	{
		RqShowDebug(_T("Warning: 关闭数据库发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
	} 
}
...
_RecordsetPtr CAdoConnection::Execute(LPCTSTR lpszSQL, long lOptions)
{
	...
	{
		RqShowDebug(_T("Warning: Execute 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoConnection::Cancel()
{
	...
	{
		RqShowDebug(_T("Warning: Cancel 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
CString CAdoConnection::GetLastErrorText()
{
	...
	{
		RqShowDebug(_T("Warning: GetLastError 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return strErrors;
	} 
	return strErrors;
}
...
ErrorsPtr CAdoConnection::GetErrors()
{
	...
	{
		RqShowDebug(_T("Warning: GetErrors 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return NULL;
	} 
	return NULL;
}
...
ErrorPtr CAdoConnection::GetError(long index)
{
	...
	{
		RqShowDebug(_T("Warning: GetError 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return NULL;
	} 
	return NULL;
}
...
long CAdoConnection::GetConnectTimeOut()
{
	...
	{
		RqShowDebug(_T("Warning: GetConnectTimeOut 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	} 
	return -1;
}
...
BOOL CAdoConnection::SetConnectTimeOut(long lTime)
{
	...
	{
		RqShowDebug(_T("Warning: SetConnectTimeOut 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
}
...
CString CAdoConnection::GetDefaultDatabase()
{
	...
	{
		RqShowDebug(_T("Warning: GetDefaultDatabase 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return CString(_T(""));
	} 
}
...
CString CAdoConnection::GetProviderName()
{
	...
	{
		RqShowDebug(_T("Warning: GetProviderName 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return CString(_T(""));
	} 
}
...
CString CAdoConnection::GetVersion()
{
	...
	{
		RqShowDebug(_T("Warning: GetVersion 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return CString(_T(""));
	} 
}
...
long CAdoConnection::GetState()
{
	...
	{
		RqShowDebug(_T("Warning: GetState 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	} 
	return -1;
}
...
BOOL CAdoConnection::IsOpen()
{
	...
	{
		RqShowDebug(_T("Warning: IsOpen 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
ConnectModeEnum CAdoConnection::GetMode()
{
	...
	{
		RqShowDebug(_T("Warning: GetMode 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
...
BOOL CAdoConnection::SetMode(ConnectModeEnum mode)
{
	...
	{
		RqShowDebug(_T("Warning: SetMode 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return TRUE;
}
...
_RecordsetPtr CAdoConnection::OpenSchema(SchemaEnum QueryType)
{
	...
	{
		RqShowDebug(_T("Warning: OpenSchema方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return NULL;
	} 
	return NULL;
}
...
long CAdoConnection::BeginTrans()
{
	...
	{
		RqShowDebug(_T("Warning: BeginTrans 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return -1;
	} 
	return -1;
}
...
BOOL CAdoConnection::CommitTrans()
{
	...
	{
		RqShowDebug(_T("Warning: CommitTrans 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoConnection::RollbackTrans()
{
	...
	{
		RqShowDebug(_T("Warning: RollbackTrans 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), __FILE__, __LINE__);
		return FALSE;
	} 
	return FALSE;
}
