...
// 		std::list<CQuestionLevelNum*>::const_iterator itr = (*itrCfg)->m_lstLevelNum.begin();
// 		for (; itr != (*itrCfg)->m_lstLevelNum.end(); ++itr)
// 		{
// 			if (((*itr)->m_uNumber) > 0)
// 			{
...
// 				if(ACCESS == dbType)
// 				{
// 					hr = GetQuestionByCfgItemFromAccess(pCfgMgr->m_uQuestionVaultID, (*itrCfg)->m_QTypeID, pQ, *itr);
// 					if (FAILED(hr))
// 					{
// 						return hr;
// 					}
...
HRESULT CSelectorEngine::GetQuestionByCfgItemFromAccess(OBJID vaultID, OBJID typeID, 
...
// 	strSQL += L" HARDLEVEL = ";
// 	CString strLevel;
// 	strLevel.Format(L"%d", pItem->m_level);
// 	strSQL += strLevel;
// 	if (pItem->m_uEachNum > 1)
// 	{
// 		strSQL += L" and QNUM = ";
// 		CString strQNum;
// 		strQNum.Format(L"%d", pItem->m_uEachNum);
// 		strSQL += strQNum;
// 	}
