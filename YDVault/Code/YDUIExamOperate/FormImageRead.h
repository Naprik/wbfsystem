...
#include "resource.h"
// FormImageread.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CFormImageRead dialog

class BASE_DLL_API CFormImageRead : public CYdFormView
{
// Construction
public:
	CFormImageRead();   // standard constructor
	virtual	~CFormImageRead();
	DECLARE_DYNCREATE(CFormImageRead)
	CBitmap   m_bmp;
	CBmpDat*  m_pBmpDat;
	CControl con[10];
	int contyp;
...
// Dialog Data
	//{{AFX_DATA(CFormImageRead)
	enum { IDD = IDD_YDUIEXAM_FORM_IMAGE_READ };
