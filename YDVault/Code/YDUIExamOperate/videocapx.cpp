...
long CVideoCapX::GetUseDeinterlace()
{
	long result;
...
void CVideoCapX::SetUseDeinterlace(long propVal)
{
...
float CVideoCapX::GetResizeCapture()
{
	float result;
...
void CVideoCapX::SetResizeCapture(float propVal)
{
...
long CVideoCapX::GetVideoRenderer()
{
	long result;
...
void CVideoCapX::SetVideoRenderer(long propVal)
{
...
CPicture CVideoCapX::GetMouseIcon()
{
...
BOOL CVideoCapX::GetUseClosedCaption()
{
	BOOL result;
...
void CVideoCapX::SetUseClosedCaption(BOOL propVal)
{
	SetProperty(0x18, VT_BOOL, propVal);
}

long CVideoCapX::GetServerTimeout()
{
	long result;
...
void CVideoCapX::SetServerTimeout(long propVal)
{
	SetProperty(0x2e, VT_I4, propVal);
}

float CVideoCapX::GetResizeBroadcast()
{
	float result;
...
void CVideoCapX::SetResizeBroadcast(float propVal)
{
	SetProperty(0xc1, VT_R4, propVal);
}

double CVideoCapX::GetScaleVideo()
{
	double result;
	GetProperty(0xc3, VT_R8, (void*)&result);
	return result;
}

void CVideoCapX::SetScaleVideo(double propVal)
{
	SetProperty(0xc3, VT_R8, propVal);
}

OLE_COLOR CVideoCapX::GetBackColor()
{
	OLE_COLOR result;
...
void CVideoCapX::SetBackColor(OLE_COLOR propVal)
{
...
CPicture CVideoCapX::GrabFrame()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x3e, DISPATCH_METHOD, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CPicture(pDispatch);
}
...
{
	VARIANT result;
	InvokeHelper(0x47, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
CPicture CVideoCapX::Acquire()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x49, DISPATCH_METHOD, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CPicture(pDispatch);
}
...
CPicture CVideoCapX::ReceiveFrame(LPCTSTR ServerName)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_BSTR;
...
long CVideoCapX::SetBitmapOverlay(long BitmapHandle, long x, long y, long TransColor, long Alpha)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4;
	InvokeHelper(0x74, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		BitmapHandle, x, y, TransColor, Alpha);
	return result;
}
...
VARIANT CVideoCapX::HTTPUpload(LPCTSTR WebServer, LPCTSTR WebPage, LPCTSTR Fields, LPCTSTR Files)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR;
	InvokeHelper(0x9c, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		WebServer, WebPage, Fields, Files);
	return result;
}

LPUNKNOWN CVideoCapX::GetVRIUnknown()
{
	LPUNKNOWN result;
...
long CVideoCapX::SetChromaKey(LPCTSTR BackImage, long MinTransparentColor, long MaxTransparentColor, long BackOrFront)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_I4 VTS_I4 VTS_I4;
	InvokeHelper(0xb2, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		BackImage, MinTransparentColor, MaxTransparentColor, BackOrFront);
	return result;
}

long CVideoCapX::PlayRemoteAudio(LPCTSTR RemoteAddress)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR;
...
long CVideoCapX::SetSourceVideoSubType(LPCTSTR SubType)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR;
...
VARIANT CVideoCapX::GetRawSample(long width)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_I4;
...
VARIANT CVideoCapX::GetVideoSubtypes()
{
	VARIANT result;
	InvokeHelper(0xb6, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}

LPUNKNOWN CVideoCapX::DvdControl()
{
	LPUNKNOWN result;
...
long CVideoCapX::SetAlphaBitmap(long hDC, float x, float y, float W, float H, float Alpha, long SrcKey)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 VTS_I4;
	InvokeHelper(0xb8, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		hDC, x, y, W, H, Alpha, SrcKey);
	return result;
}

long CVideoCapX::SetTunerMode(long Mode)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long CVideoCapX::GetVideoProcAmp(long ValueIndex)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0xbd, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		ValueIndex);
	return result;
}

void CVideoCapX::SetVideoProcAmp(long ValueIndex, long nNewValue)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4;
	InvokeHelper(0xbd, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 ValueIndex, nNewValue);
}

long CVideoCapX::PlayerOpenBroadcastPush(LPCTSTR filename, LPCTSTR URL, LPCTSTR username, LPCTSTR password)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR;
...
CString CVideoCapX::GetDeviceID(long DeviceIndex)
{
	CString result;
	static BYTE parms[] =
		VTS_I4;
...
long CVideoCapX::ApplyChromaKey(LPCTSTR SrcFile, LPCTSTR BackFile, LPCTSTR DestFile, long MinTransClr, long MaxTransClr)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_BSTR VTS_I4 VTS_I4;
	InvokeHelper(0xbc, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		SrcFile, BackFile, DestFile, MinTransClr, MaxTransClr);
	return result;
}
...
CString CVideoCapX::GetCapInfo(long ValueIndex)
{
	CString result;
	static BYTE parms[] =
		VTS_I4;
...
CString CVideoCapX::DetectMotionRects(long Divider)
{
	CString result;
	static BYTE parms[] =
		VTS_I4;
...
long CVideoCapX::SetAudioBalance(long Balance)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long CVideoCapX::SetOption(long OptionIndex, const VARIANT& Value)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_VARIANT;
...
long CVideoCapX::ConnectionState()
{
	long result;
...
long CVideoCapX::Ping(LPCTSTR ServerAddress, long Timeout)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_I4;
	InvokeHelper(0xc5, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		ServerAddress, Timeout);
	return result;
}
