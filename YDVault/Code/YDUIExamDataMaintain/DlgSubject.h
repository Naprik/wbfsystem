...
class BASE_DLL_API CDlgSubject : public CDialog
{
// Construction
public:
	CDlgSubject(OPERATION op, CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlgSubject)
	enum { IDD = IDD_YDUIEXAM_DATA_MAINTAIN_DLG_SUBJ };
