...
class BASE_DLL_API CDlgExamAddr : public CDialog
{
// Construction
public:
	CDlgExamAddr(OPERATION op, CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlgSubject)
	enum { IDD = IDD_YDUIEXAM_DATA_MAINTAIN_DLG_EXAMADDR};
