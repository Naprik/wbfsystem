...
class _ExcelApplication : public COleDispatchDriver
{
public:
	_ExcelApplication() {}		// Calls COleDispatchDriver default constructor
	_ExcelApplication(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ExcelApplication(const _ExcelApplication& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
