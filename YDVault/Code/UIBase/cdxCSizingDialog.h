...
class BASE_DLL_API cdxCSizingDialog : public CDialog
{
	/*
	 * some constants
	 */
...
class BASE_DLL_API cdxCSizingPropSheet : public CPropertySheet
{
...
class BASE_DLL_API cdxCSizingPropPage : public CPropertyPage
{
